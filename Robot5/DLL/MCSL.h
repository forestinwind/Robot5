...
#define PMC_8110_CARD				4
#define PMC_8111_CARD				5
...
/////////////////////////////////////////////////////////////////////
// Type Definitions
typedef void (MCS_CALLBACK *CYCLE_INTERRUPT_ISR)();
...
//
//--
typedef BOOL   (MCS_CALLBACK *PTP_START_MOTION) (
							int nGroup,
							int nSynAxisNum,
							int nCommandIndex,
							BOOL bAbsolute, 
...
typedef BOOL   (MCS_CALLBACK *PTP_INTERPOLATION) (
							int nGroup,
							int nSynAxisNum,
							int nCommandIndex,
							const double* pdfStartPos,
...
typedef void   (MCS_CALLBACK *PTP_CLEANUP) (
							int nGroup,
							int nCommandIndex,
							void* pvBuffer
							);

typedef double (MCS_CALLBACK *CUSTOM_START_MOTION) (
							int nGroup,
							int nSynAxisNum,
							int nCommandIndex,
							BOOL bAbsolute,
...
typedef BOOL   (MCS_CALLBACK *CUSTOM_INTERPOLATION) (
							int nGroup,
							int nSynAxisNum,
							int nCommandIndex,
							const double* pdfStartPos,
...
typedef void   (MCS_CALLBACK *CUSTOM_CLEANUP) (
							int nGroup,
							int nCommandIndex,
							void* pvBuffer
							);
...
typedef BOOL   (MCS_CALLBACK *CUSTOM_BLENDING_START) (
							int nGroup,
							int nSynAxisNum,
							int nCommandIndex,
							BOOL bAbsolute, 
...
typedef BOOL   (MCS_CALLBACK *CUSTOM_BLENDING) (
							int nGroup,
							int nSynAxisNum,
							int nCommandIndex,
...
typedef BOOL   (MCS_CALLBACK *CUSTOM_BLENDING_END) (
							int nGroup,
							int nCommandIndex,
							void* pvBuffer
							);
...
typedef void (MCS_CALLBACK *INIT_EXTENSION) (
							void* pvExtension
							);

typedef BOOL (MCS_CALLBACK *FWDKINEFUN) (
							int nGroup,
							int nSynAxisNum,
...
typedef BOOL (MCS_CALLBACK *INVKINEFUN) (
							int nGroup,
							int nSynAxisNum,
							const double* pdfFrom,
...
typedef void (MCS_CALLBACK *PRE_PROCESS_MOTION_COMMAND) (
							int nGroup,
							int nSynAxisNum,
...
typedef double (MCS_CALLBACK *INFINITE_START_MOTION) (
						    int nGroup,
						    int nSynAxisNum,
						    int nCommandIndex,
						    BOOL bAbsolute,
...
typedef BOOL   (MCS_CALLBACK *INFINITE_INTERPOLATION) (
							int nGroup,
							int nSynAxisNum,
							int nCommandIndex,
							const double* pdfStartPos,
...
typedef void   (MCS_CALLBACK *INFINITE_CLEANUP) (
							int nGroup,
							int nCommandIndex,
							void* pvBuffer
							);

typedef BOOL (MCS_CALLBACK *OFFSET_TRANSFORM) (
							int nGroup,
							int nSynAxisNum,
							int nCommandIndex,
							const double* pdfPreOffset,
							const double* pdfStartPos,
							const double* pdfCurPos,
							double* pdfNextPos,
							void *pvExtension
...
typedef void(MCS_CALLBACK *PCLISR)(PCLINT*);
typedef void(MCS_CALLBACK *ADCISR)(ADCINT*);
typedef void(MCS_CALLBACK *LIOISR)(LIOINT*);
typedef void(MCS_CALLBACK *ENCISR)(ENCINT*);
typedef void(MCS_CALLBACK *RIOISR)(RIOINT*);
typedef void(MCS_CALLBACK *TMRISR)(TMRINT*);
typedef void(MCS_CALLBACK *ALMISR)(ALMINT*);
typedef void(MCS_CALLBACK *GPIOISR)(GPIOINT*);
typedef void(MCS_CALLBACK *MPGISR)(MPGINT*);
